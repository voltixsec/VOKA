...
function reviewState(fact: ConfirmedFact | undefined, quantity: number | null) {
  return quantity !== null && fact && ["USER_APPROVED", "VERIFIED_DOCUMENT", "VERIFIED_DATABASE", "DETERMINISTIC_DERIVATION"].includes(fact.provenance) ? "CONFIRMED" as const : "NEEDS_REVIEW" as const;
}
