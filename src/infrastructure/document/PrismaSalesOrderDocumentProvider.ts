...
import {
  ...
  type SalesOrderDocumentProvider,
  type SalesOrderDocumentProviderResult,
...
export class PrismaSalesOrderDocumentProvider
  implements SalesOrderDocumentProvider {
  constructor(
    private readonly generateDocument: GenerateSalesOrderDocumentUseCase,
