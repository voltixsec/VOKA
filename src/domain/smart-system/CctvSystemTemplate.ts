  ...
  public calculate(rawInputs: Record<string, any>): SystemCalculationResult {
    ...
    const components: SystemComponent[] = [
      ...
      },
      {
        ...
        formulaExplanation: `${recorderCount} NVR(s): max(channel requirement ${channelRecorderCount} for ${nvrChannels} channels, bandwidth requirement ${bandwidthRecorderCount}, storage-bay requirement ${storageRecorderCount}). ${recorder ? "Approved recorder capabilities applied." : "Preliminary capacity; bandwidth and disk bays remain unverified."}`,
